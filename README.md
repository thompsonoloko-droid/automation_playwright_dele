...
✅ **Performance Testing** - Ready for performance and load testing (future)
...
Create or update `test_data/test_data.json` with test credentials:
...
- **test_login.py** - Data-driven login scenarios (3 parametrized tests)
- **test_checkout.py** - Cart and checkout functionality (2 tests)

### API Tests

- **test_product_api.py** - Product listing and search APIs (2 tests)
...
- `page` - Auto-navigated Playwright page with consent banner handling
- `test_data` - Loads credentials from test_data.json
...
| pytest-playwright | 0.5.1   | Pytest integration |
| allure-pytest     | 2.13.3  | Advanced reporting |
| requests          | 2.32.3  | HTTP requests      |
| pytest-html       | 4.1.1   | HTML reports       |

## 🔐 Security

- Test credentials in `test_data.json` (never commit real credentials)
